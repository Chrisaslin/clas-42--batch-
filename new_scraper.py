...
# Webdriver
browser = webdriver.Chrome("C:/Users/91880/Downloads/chromedriver_win32/chromedriver.exe")
...
new_planet_df_1.to_csv('new_scraped_data2.csv',index=True, index_label="id")
